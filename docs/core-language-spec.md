...
~~~
   ...
   - Mutual recursion: every function in a cycle states a measure, all of one type, and at a call from f to g the slot expects the measure of g at the arguments to be smaller than the measure of f at its parameters. Whether the first implementation includes this is open.
